...
<link rel="stylesheet" type="text/css" href="/resources/css/contract_printOne.css">
<!-- js파일 -->
<script src="/resources/js/navbar.js"></script>
<script src="/resources/js/contract_printOne.js"></script>
...
<body>
         ...
         <div class="col-5 colheader d-flex">
            ...
            <form class="d-flex" action="/contract/printAll" method="post">
               <input class="form-control me-sm-2" name="ssn" id="ssn" value=""
                  placeholder="주민등록번호" minlength="13"
 ...
 <div class="row text-center justify-content-center" ondblclick='showAllRows("row_${contract.number }",${json})' id='row_${contract.number }'>
      ...
      <form id="withdrawForm">
         ...
         <!-- 즉시출금본문 헤더 시작 -->
         <div class="row text-center mt-3" id="div_contract_header2">
         ...
         <!-- 즉시출금본문 클론영역 시작 -->
         <div class="row text-center justify-content-center mb-3 input_row"
            id="div_row_withdrawl"
...
<!-- 취소버튼 시작 -->
         <div class="col-6 text-start">
            <button type="button" onclick="clearInputs()"
               class="btn border bg-white text-dark mt-3">취소</button>
         </div>
   <!-- 취소버튼 끝 -->
<!-- 출금버튼 시작 -->
         <div class="col-6 text-end">
            <button type="button" onclick="withdraw()"
               class="btn bg-dark text-white mt-3">출금</button>
         </div>
<!-- 출금버튼 끝 -->
