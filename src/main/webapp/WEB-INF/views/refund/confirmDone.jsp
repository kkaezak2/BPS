...
<link rel="stylesheet" type="text/css" href="/resources/css/refund_confirmDone.css">
<!-- js파일 -->
  ...
  <jsp:include page="/WEB-INF/views/navbar.jsp" />
   ...
   <div class="mt-5" id="div_body">
      ...
      <div class="row mt-5">
         <div class="col-12">
            <h3>
               <i class="fa-solid fa-stop"></i>&nbsp;결재내역조회
            </h3>
         </div>
      ...
      <div class="confirmdone-scroll">
         <c:forEach items="${confirmAllList}" var="confirm">
         <c:if test = "${logInteamname eq confirm.teamName}">         
            <div class="row text-center">
           
               <div class="col custom-col"><a href = "/refund/confirmView/${confirm.applyNumber}" class="no-underline" id="num-confirm-done">${confirm.applyNumber}</a></div>
