...
<link rel="stylesheet" type="text/css" href="/resources/css/refund_confirmView.css">
<!-- js파일 -->
<script src="/resources/js/navbar.js"></script>
<script src="/resources/js/refund_confirmView.js"></script>
</head>
...
<body>
	...
	<div class="mt-5" id="div_body">
		...
		<div class="row mt-5">
			<div class="col-12">
				<h3>
					<i class="fa-solid fa-stop"></i>&nbsp;결재내역상세조회
				</h3>
			</div>
...
<form action="/refund/updateConfirm" method="post">
<div class="refund-scroll">
         <c:forEach items="${confirmList}" var="confirm">
            ...
            <input type="hidden" name="applyNumber"
               value="${confirm.applyNumber}">
            <input type="hidden" name="allPaymentId"
